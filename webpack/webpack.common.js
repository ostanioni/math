...
// const ENTRY = path.resolve(__dirname, '../src/index.ts'); //'./src/index.ts'
...
const IMAGES = {
  ...
  use: [
    {
      loader: 'file-loader',
      /*exclude: [/\.(js|mjs|jsx|ts|tsx)$/, /\.html$/, /\.json$/],*/ options: {
        name(file) {
...
const MD = {
  test: /\.md$/,
  use: [{ loader: 'raw-loader' }, { loader: 'markdown-loader', options: {} }],
};
...
const $STYLE_LOADER_OR_MINI_CSS_LOADER = devMode
  ? $STYLE_LOADER
  : $MINI_CSS_LOADER;
/***___SCSS_CSS___ ***/
const SCSS = {
